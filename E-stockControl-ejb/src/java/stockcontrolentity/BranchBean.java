...
this.setBranchCode(key);
    ...
    public abstract String getBranchAddress();

    public abstract void setBranchAddress(String branchAddress);

    public abstract String getDateCreated();

    public abstract void setDateCreated(String dateCreated);

    public abstract String getBranchStatus();

    public abstract void setBranchStatus(String branchStatus);
