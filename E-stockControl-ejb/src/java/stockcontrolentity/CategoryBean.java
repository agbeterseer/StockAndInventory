...
this.setCategorycode(key);
    ...
    public abstract void setStockItemType(String stockItemType);

    public abstract String getCategorydescription();

    public abstract void setCategorydescription(String categorydescription);
