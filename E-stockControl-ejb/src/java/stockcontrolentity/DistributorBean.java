...
this.setUsername(key);
    ...
    public abstract String getOfficeAddress();

    public abstract void setOfficeAddress(String officeAddress);
    ...
    public abstract String getStateororigin();

    public abstract void setStateororigin(String stateororigin);
