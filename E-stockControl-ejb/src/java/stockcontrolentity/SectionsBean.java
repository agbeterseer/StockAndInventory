 ...
 */
public abstract class SectionsBean implements EntityBean {
    ...
    public abstract Integer getTrack();

    public abstract void setTrack(Integer track);
    ...
    public Integer ejbHomeMax()  throws FinderException{
      SectionsLocalHome sl = (SectionsLocalHome)context.getEJBLocalHome();
