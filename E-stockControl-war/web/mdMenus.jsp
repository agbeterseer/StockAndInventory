<%-- 
    Document   : mdMenus
    Created on : Jul 28, 2011, 11:24:04 AM
    Author     : Terseer
--%>
...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  <td width="21%" rowspan="3"><div id="header"> </div></td>
    ...
    <td width="10%" rowspan="3"><div style="float:right; padding-right:10px"><img src="images/tm_small.gif" width="87" height="28" /></div></td>
  </tr>
...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  <tr valign="top">
	...
	<td><div class="SIDE">
      <a href="javascript: d.openAll();" ><span style="color:#00FF66">Expand All</span></a>
											<span class="WW">|</span>
										<a href="javascript: d.closeAll();"><span  style="color:#00FF66" >Close All</span></a>&nbsp;&nbsp;&nbsp;
									</div></td></tr>
      <tr>
		...
		//d.add(26,8,'Personal','web001/addMoreAccountsToPersonalCustomer.jsp','','ifrm');
             ...
             //   d.add(33,30,'All Accounts','web001/viewAllAccounts.jsp','','ifrm');
               // d.add(34,0,'All Staffs','');
                d.add(36,0,'All Staffs','');

               d.add(37,0,'Supplies','');
              d.add(38,0,'All Reports','');
               d.add(39,0,'Profile','');



               d.add(371,37,'All Supplies Made','viewAllSupplies.jsp','','ifrm');
              // d.add(372,37,'All Roles & Modify','viewAllRoles.jsp','','ifrm');
              ...
              //  d.add(374,37,'End Of Month Debit Process','web002/DebitInterest.jsp','','ifrm');
               // d.add(375,37,'End Of Month Credit Process','web002/CreditInterest.jsp','','ifrm');
                ...
                d.add(361,36,'View All Staff','viewAllStaff.jsp','','ifrm');
              //  d.add(362,36,'Make Changes','viewAllStaff.jsp','','ifrm');
               // d.add(363,36,'Search By Category','viewStaffByCategory.jsp','','ifrm');
               // d.add(364,36,'modify Staff Records','adminModifyStaffRecords.jsp','','ifrm');

              // d.add(300,34,'Create Units','addUnits.jsp','','ifrm');
              //  d.add(303,34,'Create Units','addUnits.jsp','','ifrm');
             //  d.add(301,34,'Search All & Modify','viewAllUnits.jsp','','ifrm');
              // d.add(302,34,'Search By Category','viweUnitsByCategory.jsp','','ifrm');
             //  d.add(303,34,'Set Limits','createLimits.jsp','','ifrm');
              // d.add(304,34,'see Limits','viewAllLimits.jsp','','ifrm');
               ...
               // d.add(300010,30001,'View Batch Transaction','web001/viewBatchTransactionsByDate.jsp','','ifrm');
                ...
                //  d.add(300013,30001,'View Posted Transaction','web001/viewAllPostedTransactions.jsp','','ifrm');
                 ...
                 //d.add(3800,38,'Entries','');
                  d.add(3811,38,'Report on Staffs','staffReportPDF.jsp','','ifrm');
                  d.add(3812,38,'Report on Stocks','stockReportPDF.jsp','','ifrm')
                d.add(3813,38,'Report on Supply','supplyReportPDF.jsp','','ifrm');
