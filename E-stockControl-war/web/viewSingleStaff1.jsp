<%-- 
    Document   : viewSingleStaff1
    Created on : Oct 31, 2011, 1:13:04 PM
    Author     : Terseer
--%>
...
<html>
   ...
   <%
        ...
        try{
            ...
            hstaff = scl.viewSingleStaff(code);
    ...
    <fieldset style="width:600px; " >
        <legend><font face="Arial, Helvetica, sans-serif"  color="#669966"><strong>Personal Details</strong></font></legend>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                      <td width="42%"> <input name="regno" type="hidden" id="regno" value="<%=hstaff.getUsername()%>"></td>
                    <td width="46%">&nbsp;</td>
                    <td width="12%"><a href="javascript:window.print();">[Print]</a></td>
                </tr>
                  <tr>
