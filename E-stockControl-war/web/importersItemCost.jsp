<%-- 
    Document   : importersItemCost
    Created on : Oct 27, 2011, 9:39:08 AM
    Author     : Terseer
--%>
...
<html>
    <head>
        ...
        <title>importers Item Cost</title>
       ...
       try{
        ...
        String dateadded = request.getParameter("dateadded");
            ...
            try{
                ...
                msg = scl.addInventoryCost2(new HelpInventoryCost(new Integer(code),dateadded, new Float(expense), new Float(purches), new Float(exchangerate), new Float(freight)));
