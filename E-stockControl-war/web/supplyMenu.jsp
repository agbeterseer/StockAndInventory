<%-- 
    Document   : supplyMenu
    Created on : Jun 30, 2011, 12:08:26 PM
    Author     : Terseer
--%>
      ...
      <tr>
		...
		//d.add(26,8,'Personal','web001/addMoreAccountsToPersonalCustomer.jsp','','ifrm');
             ...
             //   d.add(33,30,'All Accounts','web001/viewAllAccounts.jsp','','ifrm');
                d.add(34,0,'Supply','');
                d.add(36,0,'Requisition','');

               d.add(37,0,'Profile','');
              d.add(38,0,'Reports','');
               // d.add(39,0,'Setups','');

               d.add(371,37,'View Records','viewSingleStaff.jsp','','ifrm');
              ...
              //  d.add(374,37,'End Of Month Debit Process','web002/DebitInterest.jsp','','ifrm');
               // d.add(375,37,'End Of Month Credit Process','web002/CreditInterest.jsp','','ifrm');
                ...
                d.add(361,36,'Make Request','singleRequest.jsp','','ifrm');
                d.add(362,36,'See All Request Made','viewAllRequest.jsp','','ifrm');
               // d.add(363,36,'Search By Category','viewAllRequestByCategory.jsp','','ifrm');

                d.add(300,34,'Make Supply','makeSupply.jsp','','ifrm');
              //  d.add(303,34,'Create Units','addUnits.jsp','','ifrm');
                d.add(301,34,'Search All Supplies','viewAllSupplies.jsp','','ifrm');
               // d.add(302,34,'Search Store By Category','viewSupplyByCategory.jsp','','ifrm');
               ...
               // d.add(300010,30001,'View Batch Transaction','web001/viewBatchTransactionsByDate.jsp','','ifrm');
                ...
                //  d.add(300013,30001,'View Posted Transaction','web001/viewAllPostedTransactions.jsp','','ifrm');
                 ...
                 //d.add(3800,38,'Entries','');
                  d.add(3811,38,'See Reports','supplyReportPDF.jsp','','ifrm');
               ...
               //  d.add(382,3800,'Detail Trial Balance','web002/trialbalance.jsp','','ifrm');
                ...
                // d.add(388,38,'View All Staff','web002/viewStaff.jsp','','ifrm');
                  //d.add(3902,39,'Class Type','web002/ClassTypes.jsp','','ifrm');
