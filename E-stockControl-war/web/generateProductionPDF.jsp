<%-- 
    Document   : generateProductionPDF
    Created on : Jul 3, 2011, 8:18:57 AM
    Author     : Terseer
--%>
...
<html>
    <head>
        ...
        <title>generate ProductionPDF</title>
    </head>
    <body>
      <%
        ...
        <%
               ...
               InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/WEB-INF/productionreport1.jasper");
