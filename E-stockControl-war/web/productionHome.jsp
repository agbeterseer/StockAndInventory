<%-- 
    ...
    Created on : Jun 16, 2011, 12:54:29 PM
    Author     : Terseer
--%>
...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  <tr><td width="60%"><strong><font size="+1" color="#999966">Welcome ! &nbsp; <%=stname%></font></strong></td>
    <td width="9%"></td>
  </tr>
  </table>
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  <tr valign="top">
    <td width="21%"><table border="0" cellspacing="3" cellpadding="0" class="menus" width="100%">
	<td><div class="SIDE">
      ...
      <tr>
		...
		//d.add(26,8,'Personal','web001/addMoreAccountsToPersonalCustomer.jsp','','ifrm');
             ...
             //   d.add(32,30,'By Account Number','web001/customerSingleSearch.jsp','','ifrm');
                ...
                d.add(34,0,'Materials','');
                
                d.add(36,0,'Goods','');
                d.add(37,0,'Inventory Costing','');
               d.add(38,0,'Profile','');
                d.add(39,0,'Reports','');
                d.add(310,0,'Requisition','');

                //
                  d.add(371,38,'View Records','viewSingleStaff.jsp','','ifrm');
                 d.add(372,37,'Modify Records','makeCostAnalysis.jsp.jsp','','ifrm');
                 d.add(3052,37,'view AllAnalysis','viewAllCostAnalysis.jsp','','ifrm');
                //d.add(371,37,'Day Begin','web002/Daybegin.jsp','','ifrm');
               // d.add(371,37,'End of Day Process','web002/endOfDayprocess1.jsp','','ifrm');
              ...
              //  d.add(374,37,'End Of Month Debit Process','web002/DebitInterest.jsp','','ifrm');
               // d.add(375,37,'End Of Month Credit Process','web002/CreditInterest.jsp','','ifrm');
                ...
                d.add(361,36,'Complete Production','addProduction.jsp','','ifrm');
                d.add(362,36,'Make Changes','viewAllProductions.jsp','','ifrm');
                d.add(363,36,'Search By Category','viewProductionByCateria.jsp','','ifrm');
                
                d.add(300,34,'Add Materials','addMaterials.jsp','','ifrm');
                d.add(301,34,'Search All Materials ','viewAllMaterials.jsp','','ifrm');
                d.add(302,34,'Search By Category','viewSingleMaterial.jsp','','ifrm');
               ...
               // d.add(300010,30001,'View Batch Transaction','web001/viewBatchTransactionsByDate.jsp','','ifrm');
                ...
                //  d.add(300013,30001,'View Posted Transaction','web001/viewAllPostedTransactions.jsp','','ifrm');
                 ...
                 d.add(3811,39,'See Reports','productionReportPDF.jsp','','ifrm');
                 // d.add(3812,38,'Customer Balances','web001/customerSingleSearch.jsp','','ifrm');
               ...
               //  d.add(381,380,'View Chart of Account','web002/DisplayGlAcctNE.jsp','','ifrm');
                ...
                d.add(3902,310,'See All Request Made','viewAllRequest.jsp','','ifrm');
                //d.add(391,39,'Banking Setup','web002/BankingSetup.jsp','','ifrm');
