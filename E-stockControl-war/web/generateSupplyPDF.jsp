<%-- 
    Document   : generateSupplyPDF
    Created on : Jul 3, 2011, 8:55:07 AM
    Author     : Terseer
--%>
...
<html>
    <head>
        ...
        <title>generate SupplyPDF</title>
    </head>
    <body>
    <%
        ...
        <%
               ...
               InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/WEB-INF/supplyReport.jasper");
