...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="18" class="tableheader"><strong>..:: view Items By Category ::..</strong></td>
    </tr>
</table>
  <table width="80%" border="0" cellspacing="0" cellpadding="0">
    <tr>
...
<table width="80%" border="0" cellspacing="0" cellpadding="0" id="results">
  ...
  <tr>
   ...
   <%
     ...
     %>
  <tr class="<%=style%>">
    <td height="28" class="tab_lebel"><a href="viewSingleCategoryWithItems.jsp?code=<%=hcc.getCategorycode()%>"><%=hcc.getStockItemType()%></a></td>
    <td class="tab_lebel"><a href="viewItemsByCategory.jsp?code=<%=hcc.getCategorycode()%>">[Action]</a></td>
  </tr>
  <%
  count++;
  }
