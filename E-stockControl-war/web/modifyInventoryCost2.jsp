<%-- 
    Document   : modifyInventoryCost2
    Created on : Oct 28, 2011, 3:55:58 PM
    Author     : Terseer
--%>
...
<html>
        ...
        String dateadded = request.getParameter("dateadded");
            ...
            try{
                ...
                if(request.getParameter("button") !=null){
                 ...
                 msg = scl.modifyInventoryCost2(new HelpInventoryCost(code,new Float(matcost),new Float(labourcost),new Float(overheadcost),null,dateadded));
  ...
  <tr>
    <td height="30" colspan="2"  class="<%=style%>"><%=msg%></td>
  </tr>
  <tr>
    <td width="36%" class="tab_lebel">Item</td>
    <td width="61%"><label>
            <input type="text" name="commodityname" id="commodityname" style="width:200px;" value="<%=scl.viewSingleCommodity2(code).getItemname()%>" readonly>
    </label></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><label>
     <input type="text" name="labourcost" id="labourcost" style="width:200px;" value="<%=hic.getLabourCost()%>">
    </label></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" name="overheadcost" id="overheadcost" style="width:200px;" value="<%=hic.getOverheadCost()%>"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" name="dateadded" id="dateadded" style="width:200px;" value="<%=hic.getDateCreated()%>">
