<%-- 
    Document   : generateStockPDF
    Created on : Jul 1, 2011, 3:33:28 PM
    Author     : Terseer
--%>
<%@page import="java.io.*"%>
    ...
    <body>
      ...
      response.sendRedirect("errorpage.jsp");
        ...
        <%
               ...
               InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("/WEB-INF/stockReport.jasper");
