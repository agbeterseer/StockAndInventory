<%-- 
    Document   : adminViewStaffRecordsByCategory
    Created on : Jun 30, 2011, 2:21:52 PM
    Author     : Terseer
--%>
...
<html>
  ...
  <tr class="<%=style%>">
    ...
    <td>[view..]</td>
    <td><a href="adminModifyStaffRecords.jsp?code=<%=ssh.getUsername()%>"><img src="img/edit.png" alt="no image"></a></td>
